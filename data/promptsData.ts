...
输出要偏实战，方便我直接分工执行。`,
  },
  {
    ...
    category: '课程复习 / 实验报告',
    tags: ['复习', 'PPT', '笔记'],
    description: '把课程 PPT / PDF 课件内容压缩成适合考前快速浏览的复习笔记。',
    updatedAt: '2026-05-18',
    prompt: `请将我上传的 PPT / PDF 课件内容整理成一份"考前复习笔记"。\n\n整理要求如下：\n\n1. 按照课件原有章节结构进行归纳，不要打乱逻辑顺序。\n2. 不要照抄原文，要提炼、压缩、重组为适合考前快速浏览的笔记。\n3. 每一章请包含以下内容：\n   - 本章核心概念\n   - 重要公式及其含义\n   - 常见易错点\n   - 典型题型 / 常见考法\n   - 记忆提示或理解口诀\n\n4. 所有数学公式必须使用标准 LaTeX 格式输出，行内公式用 $...$，独立公式用 $$...$$。对每个公式请说明：\n   - 公式适用条件\n   - 每个符号的含义（首次出现时标注清楚，含角标）\n   - 做题时如何使用\n   - 容易代错或漏掉的地方\n\n5. 对重点概念，请用通俗语言解释，尽量做到"初学者也能看懂"。\n6. 如果 PPT 中有图表、流程图或实验步骤，请转化为文字版总结，保留其核心逻辑。\n7. 内容要简洁清晰，适合考前快速复习，不要写成大段论文式文字。\n8. 整体排版要美观，层级分明：\n   - 使用 # ## ### 等标题层级\n   - 关键术语加粗\n   - 公式独占一行，前后留空行\n   - 适当使用表格、列表、分隔线\n   - 方便直接复制到 Word / Typst / LaTeX 中使用。`,
  },
  {
    title: '论文降AI率大师',
    category: 'AI 降重 / 改写',

    ...
    <div className="grid gap-5 md:grid-cols-2">
      {contentSections.map((section) => (
        <Link
          key={section.href}
          href={section.href}
          className="group relative overflow-hidden rounded-[1.75rem] border border-white/28 bg-white/52 p-6 shadow-xl shadow-slate-950/15 backdrop-blur-2xl transition duration-300 hover:-translate-y-1 hover:bg-white/64 hover:shadow-2xl hover:shadow-pink-950/20 dark:border-slate-400/20 dark:bg-slate-950/45 dark:hover:bg-slate-900/60"
        >

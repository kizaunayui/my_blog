      ...
      {loadComments ? (
        ...
        <div className="flex justify-center py-4">
          <button
            ...
            className="editorial-action editorial-action--quiet group font-heading relative inline-flex items-center gap-2 overflow-hidden rounded-full border border-white/15 bg-transparent px-8 py-3.5 text-[10px] font-bold tracking-[0.2em] text-slate-200 uppercase transition-all duration-300 hover:border-cyan-500/35 hover:text-cyan-300 focus:outline-none"
          >

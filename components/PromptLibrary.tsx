...
export default function PromptLibrary({ prompts }: PromptLibraryProps) {
  ...
  return (
    <div className="space-y-10 pb-14 pt-8 sm:pt-12">
      <section className="relative overflow-hidden rounded-3xl border border-white/55 bg-white/58 px-5 py-9 shadow-2xl shadow-primary-100/70 backdrop-blur-md sm:px-8 sm:py-12 dark:border-white/10 dark:bg-gray-950/52 dark:shadow-primary-950/30">
        ...
        {filteredPrompts.map((item, index) => (
          ...
          >
            <div className="flex flex-1 flex-col gap-5">
              ...
              <pre className="max-h-72 overflow-auto whitespace-pre-wrap break-words rounded-2xl border border-gray-200/80 bg-white/64 p-4 text-sm leading-7 text-gray-700 shadow-inner shadow-gray-100/60 backdrop-blur dark:border-gray-800/80 dark:bg-gray-950/54 dark:text-gray-200 dark:shadow-black/20">
                {item.prompt}
              </pre>
            </div>
